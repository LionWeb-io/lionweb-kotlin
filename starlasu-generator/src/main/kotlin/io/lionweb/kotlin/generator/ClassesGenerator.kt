...
class ClassesGeneratorCommand : CliktCommand("classgen") {
    ...
    private fun generateDeserializer(language: Language, overridenName: String?) {
        ...
        val deserializer = FunSpec.builder("registerDeserializersFor${langName.capitalize()}")
        ...
        """.trimIndent(),
                rpgLanguage, instantiatorClassifier, astClass, astClass,
            )
    ...
    private fun generateFeature(
        ...
        when (feature) {
            ...
            is Reference -> {
                ...
                val baseType: TypeName =
                    when {
                        featureType.language == container.language -> ClassName(
                            packageName, featureType.name!!)
                        featureType ==
